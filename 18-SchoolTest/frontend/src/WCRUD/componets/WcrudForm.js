...
import classes from '../CSS/WcrudForm.module.css';

function WcrudForm({ method, student }) {
...
export async function action({ request, params }) {
  ...
  if (method === 'PATCH') {
    const wcrudId = params.wcrudId;// link to App.js file
    url = 'http://localhost:8080/students/' + wcrudId;
  }
