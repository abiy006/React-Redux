...
// VARIABLE SAMPLEB ENDING
  ...
  } = useRouteLoaderData("wcrud-dynamic-detail");
  // const { payment, payments } = useRouteLoaderData("wcrud-dynamic-detail");
  ...
  console.log("WcrudXDetailPage - samplef - " + samplef);
  console.log("WcrudXDetailPage - samplefs - " + samplefs);
  return (
    <>
...
export async function loader({ request, params }) {
  const id = params.wcrudDynamicId;
...
//   const response = await fetch("http://localhost:8080/students/" + wcrudId, {
